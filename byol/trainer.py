...
class BYOLTrainer:
    def __init__(self, online_network, target_network, predictor, device, dataset, idxs, args, **params):
        self.online_network = online_network
        self.target_network = target_network
        self.optimizer = torch.optim.SGD(list(online_network.parameters()) + list(predictor.parameters()),
    ...
    def train(self):
        ...
        for epoch_counter in range(self.args.local_epochs):
